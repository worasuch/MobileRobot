...
double setpoint = 30000;//3072;//I am setting it to move through 100 degrees
double Kp = 0.128;//0.015;// you can set these constants however you like depending on trial & error
double Ki = 0.000605866;//0.000071;//0.000109;
double Kd = 0.93866;//0.1009;
...
void PIDcalculation(){
  //angle = ( 0.1171875 * count);//count to angle conversion
  angle = ( 0.1171875 * count);
